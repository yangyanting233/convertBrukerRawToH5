...
%----------------------------------------------------------------
    ...
    if bruker_getAcqPvVersion(Acqp, 'is360')
        [ data , addInfo] = readBrukerRawFromPv360(Acqp, varargin{1,1});
    else
        [ data , addInfo] = readBrukerRawTillPv360(Acqp, varargin{1,1});
    end
end
...
%----------------------------------------------------------------
    ...
    if ~jobsExist || (length(specified_Jobs)==1 && specified_Jobs(1)==-1) 
...
%----------------------------------------------------------------
function [ data , addInfo] = readBrukerRawFromPv360(Acqp, varargin)
    %% Define default-value if necesseary:
...
%----------------------------------------------------------------
    ...
    %----------------------------------------------------------------------    
    if (length(specified_Jobs)==1 && ~(specified_Jobs(1)==-1) || length(specified_Jobs)~=1 )
